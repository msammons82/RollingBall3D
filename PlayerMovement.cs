...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate() 
    {
        ...
        //create a new ray, it's center is the players position, it's direction is Vector3.down
        Ray ray = new Ray(transform.position, Vector3.down);
        //Physics.Raycast will return true if the ray hits a collider
        //send the ray and check if it did hit anything, the ray length is going to be half of our scale(players radius)
